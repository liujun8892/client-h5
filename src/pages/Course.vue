...
backgroundRepeat: 'no-repeat'
    ...
    <div class="content_box">
      <div class="content_box_pos">
        <div class="teacher_avatar" :style="{
...
backgroundRepeat: 'no-repeat'
  ...
  <div v-if="courseIntroduce.type==1">
    ...
    <video id="myVideo" ref="myVideo" class="video-js vjs-default-skin vjs-big-play-centered vjs-16-9" controls type="application/x-mpegURL" allowsInlineMediaPlayback=YES webview.allowsInlineMediaPlayback=YES webkit-playsinline="true" playsinline="true" x5-video-player-type="h5" x5-video-player-fullscreen="true" :poster="iconURL + courseIntroduce.cover">
    </video>
